...
(function () {
  ...
  const TYPE_NAMES = {
    ...
    crossword: 'Crossword', krisskross: 'Kriss-Kross', nonogram: 'Nonogram', trivia: 'Trivia Quiz', riddles: 'Riddles', brainteasers: 'Brain Teasers', mathpuzzles: 'Math Puzzles', xsudoku: 'X-Sudoku', minisudoku: 'Mini Sudoku', evenodd: 'Even-Odd Sudoku', kakuro: 'Kakuro', logicgrid: 'Logic Grid', wordladder: 'Word Ladder', wordwheel: 'Word Wheel', cipher: 'Cipher',
